...
for k in range(N):
    ...
    Factorials_of_abs_values[k] = math.factorial(abs(int(Coordinates[k])))

print(f'Number of shortest possible paths = {math.factorial(Sum_of_abs_values(Coordinates))//Product_of_list_values(Factorials_of_abs_values)}')
